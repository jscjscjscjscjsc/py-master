"""Test Doubao TTS with credentials supplied through local environment variables."""
import json, urllib.request, urllib.error, uuid, base64, os, tempfile

APP_ID = os.environ.get("DOUBAO_TTS_APP_ID", "")
TOKEN = os.environ.get("DOUBAO_ACCESS_TOKEN", "")
if not APP_ID or not TOKEN:
    raise SystemExit("Set DOUBAO_TTS_APP_ID and DOUBAO_ACCESS_TOKEN before running this manual test.")
AUTH = "Bearer; " + TOKEN
    ...
    try:
        ...
        if code == 3000:
            ...
            if data_b64:
                ...
                out = os.path.join(tempfile.gettempdir(), f"pymaster-tts-{cluster}.mp3")
